...
class WKWebViewController: UIViewController{
    ...
    var frame = CGRect.init(x: 0, y: 0, width: ScreenW, height: ScreenH - 64)
...
extension WKWebViewController{
    ...
    fileprivate func addProgressView() {
        ...
        progressView?.progressTintColor = kGlobalColor
//        progressView?.isHidden = isProgressHidden 好尴尬  不生效
    ...
    fileprivate func updateNavigationItems(){
        ...
        if webView.canGoBack {
            ...
            navigationItem .setRightBarButtonItems([space,closeButtonItem], animated: false)
            navigationItem .setLeftBarButtonItems([space,customBackBarItem], animated: false)
...
//        backButton.frame = CGRect(x: 0, y: 0, width: 40, height: 38)
